...
from backend.app import models  # noqa: E402, F401  (register metadata)

config = context.config
if config.config_file_name is not None:
    fileConfig(config.config_file_name)

# Allow override via env for production deploys.
override_url = os.environ.get("RELAY_DB_URL") or os.environ.get("DATABASE_URL")
if override_url:
